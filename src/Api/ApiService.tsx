...
const mockPages: Page[] = [
  // Dashboard
  {
    ...
    icon: <AppIcon name="dashboardIcon" size={20} stroke={1.5} />,
    order: 1,
    isActive: true,
    iconActive: <AppIcon name="dashboardFilledIcon" size={20} stroke={1.5} />,
  },
  ...
  // Task Manager
  {
    ...
    name: "Task Manager",
    path: "/tasks-manager",
    icon: <AppIcon name="tasks" size={20} stroke={1.5} />,
    order: 3,
    isActive: true,
  },
  {
  ...
  // Users
  {
    ...
    name: "Users",
    path: "/users",
    icon: <AppIcon name="users" size={20} stroke={1.5} />,
    order: 4,
    isActive: true,
  },
  // Children of Users
  ...
  // Locations
  {
    ...
    name: "Locations",
    path: "/locations",
    icon: <AppIcon name="map_pin" size={20} stroke={1.5} />,
    order: 5,
    isActive: true,
  },
  {
  ...
  // Mobile
  {
    ...
    name: "Mobile",
    path: "/mobile",
    icon: <AppIcon name="mobile" size={20} stroke={1.5} />,
    order: 6,
    isActive: true,
  },
  {
  ...
  // Supported Living
  {
    ...
    name: "Supported Living",
    path: "/supported-living",
    icon: <AppIcon name="home" size={20} stroke={1.5} />,
    order: 7,
    isActive: true,
  },
  {
  ...
  // Reports
  {
    ...
    name: "Reports",
    path: "/reports",
    icon: <AppIcon name="analytics" size={20} stroke={1.5} />,
    order: 8,
    isActive: true,
  },
  {
  ...
  // Timesheets
  {
    ...
    name: "Timesheets",
    path: "/timesheets",
    icon: <AppIcon name="report" size={20} stroke={1.5} />,
    order: 10,
    isActive: true,
  },
  ...
  // Documents
  {
    ...
    name: "Documents",
    path: "/documents",
    icon: <AppIcon name="document" size={20} stroke={1.5} />,
    order: 12,
    isActive: true,
  },
  {
  ...
  // Messaging
  {
    ...
    name: "Messaging",
    path: "/messaging",
    icon: <AppIcon name="message" size={20} stroke={1.5} />,
    order: 13,
    isActive: true,
  },
  {
  ...
  // Logout (no children)
  {
    ...
    name: "Logout",
    path: "/logout",
    icon: <AppIcon name="logout" size={20} stroke={1.5} />,
    order: 16,
    isActive: true,
  },
];
