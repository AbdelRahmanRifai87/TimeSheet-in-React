export const topBarStyles = {
  ...
  searchContainer:
    "flex items-center bg-white/40 w-full h-[36px] max-w-[280px] bg-[#0000] rounded-[6px] px-[12px] py-[6px] transition-colors duration-500",
  ...
  avatar: "w-[36.27px] h-[36px] rounded-full  ",
  userName:
    "ml-[12px]  font-normal text-sm lowercase opacity-90 md:inline whitespace-nowrap",
