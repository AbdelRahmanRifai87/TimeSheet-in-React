export const topBarStyles = {
  ...
  iconButton:
    "ml-[8px] w-[36px] h-[36px] flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border-none cursor-pointer transition-colors duration-500",
  icon: "text-white text-[18px] transition-colors duration-500",
