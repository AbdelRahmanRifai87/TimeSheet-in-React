...
export const topBarStyles = {
  topbar:
    "  fixed top-0 right-0 w-[87vw] h-[60px] px-[16px] flex items-center justify-between bg-[#0078d4] text-white z-[9999] ",
  companyContainer:
  ...
  searchContainer:
    ...
    "flex items-center w-full max-w-[300px] bg-[#0b85e1] rounded-[6px] px-[12px] py-[6px]",
